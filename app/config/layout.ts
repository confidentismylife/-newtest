...
export const layouts: Record<string, Layouts> = {
  all: {
    ...
    sm: [
      ...
      { i: "blog", x: 0, y: 4, w: 2, h: 2 },
      { i: "iconCloud", x: 0, y: 6, w: 1, h: 1 },
      { i: "show", x: 1, y: 6, w: 1, h: 2 },
  ...
  projects: {
    lg: [
      ...
      { i: "blog", x: 3, y: 0, w: 1, h: 2 },
      { i: "show", x: 0, y: 0, w: 1, h: 4 },
